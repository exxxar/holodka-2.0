import { onMounted, onUnmounted, computed, ref, mergeProps, useSSRContext, unref, withCtx, renderSlot, resolveComponent, createVNode, createTextVNode, toDisplayString, openBlock, createBlock } from "vue";
...
import { A as ApplicationLogo } from "./ApplicationLogo-Dsp8Rdoh.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        href: _ctx.route("persons"),
        active: _ctx.route().current("persons")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Собранные клиенты `);
          } else {
            return [
              createTextVNode(" Собранные клиенты ")
            ];
          }
        }),
        _: 1
