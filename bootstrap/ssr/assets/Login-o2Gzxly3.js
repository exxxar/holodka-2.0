...
import { _ as _sfc_main$2 } from "./GuestLayout-CLcCnIW6.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$2, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Вход" }, null, _parent2, _scopeId));
            if (__props.status) {
            ...
            return [
              createVNode(unref(Head), { title: "Вход" }),
